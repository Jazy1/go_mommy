			...
			<div class="container position-relative">
				<div class="row">
					<div class="col-xxl-10 col-xl-9 col-lg-10 col-md-10 m-auto">
						<h1 class="hero-heading text-center wow fadeInUp">Get the ideal home for your <span class="d-inline-block position-relative">family <img src="images/lazy.svg" data-src="images/shape/shape_01.svg" alt="" class="lazy-img"></span></h1>
						<p class="fs-24 color-dark text-center pt-35 pb-35 wow fadeInUp" data-wow-delay="0.1s">We’ve more than 745,000 apartments, place & plot.</p>
					</div>
				</div>
				<div class="row">
			...
			<div class="container">
				<div class="position-relative z-1">
					<div class="title-one text-center mb-75 xl-mb-50 md-mb-30 wow fadeInUp">
						<h3>Explore Different <span>Categories <img src="images/lazy.svg" data-src="images/shape/title_shape_02.svg" alt="" class="lazy-img"></span></h3>
						<p class="fs-22">Explore the latest & exciting themes in diverse categories</p>
					</div>
					<!-- /.title-one -->
					...
					<div class="property-location-slider-one">
						<div class="item">
							<div class="location-card-one position-relative z-1 d-flex align-items-end" style="background-image: url(images/media/img_05.jpg);">
								<div class="content text-center w-100 tran3s">
									<h5 class="text-white fw-normal">Portfolio</h5>
									<p class="text-white fw-light">1,230 Themes</p>
								</div>
						...
						<div class="item">
							<div class="location-card-one position-relative z-1 d-flex align-items-end" style="background-image: url(images/media/img_06.jpg);">
								<div class="content text-center w-100 tran3s">
									<h5 class="text-white fw-normal">Food & Drink</h5>
									<p class="text-white fw-light">1,190 Themes</p>
								</div>
								<a href="listing_01.html" class="stretched-link"></a>
							</div>
							<!-- /.location-card-one -->
						...
						<div class="item">
							<div class="location-card-one position-relative z-1 d-flex align-items-end" style="background-image: url(images/media/img_07.jpg);">
								<div class="content text-center w-100 tran3s">
									<h5 class="text-white fw-normal">News</h5>
									<p class="text-white fw-light">1,710 Themes</p>
								</div>
								<a href="listing_01.html" class="stretched-link"></a>
							</div>
							<!-- /.location-card-one -->
						...
						<div class="item">
							<div class="location-card-one position-relative z-1 d-flex align-items-end" style="background-image: url(images/media/img_08.jpg);">
								<div class="content text-center w-100 tran3s">
									<h5 class="text-white fw-normal">Education</h5>
									<p class="text-white fw-light">670 Themes</p>
								</div>
								<a href="listing_01.html" class="stretched-link"></a>
							</div>
							<!-- /.location-card-one -->
						...
						<div class="item">
							<div class="location-card-one position-relative z-1 d-flex align-items-end" style="background-image: url(images/media/img_09.jpg);">
								<div class="content text-center w-100 tran3s">
									<h5 class="text-white fw-normal">Entertainment</h5>
									<p class="text-white fw-light">1,670 Themes</p>
								</div>
								<a href="listing_01.html" class="stretched-link"></a>
							</div>
							<!-- /.location-card-one -->
