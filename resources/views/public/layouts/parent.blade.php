						...
						<div class="form-wrapper m-auto">
							<ul class="nav nav-tabs w-100" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link {{ $tab == "login" ? "active" : "" }}" data-bs-toggle="tab" data-bs-target="#fc1" role="tab">User Login</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link {{ $tab == "signup" ? "active" : "" }}" data-bs-toggle="tab" data-bs-target="#fc2" role="tab">User Signup</button>
								</li>
							</ul>
