	...
	<div class="hero-banner-four position-relative">
		<div class="position-relative main-bg position-relative z-1 pt-150 xl-pt-120 md-pt-60 pb-150 xl-pb-120 md-pb-80">
			<div class="hero-slider-one m0">
				<div class="item m0"><div class="hero-img" style="background-image: url({{ asset("images/media/img_57.jpg") }});"></div></div>
				<div class="item m0"><div class="hero-img" style="background-image: url({{ asset("images/media/img_60.jpg") }});"></div></div>
				<div class="item m0"><div class="hero-img" style="background-image: url({{ asset("images/media/img_59.jpg") }});"></div></div>
				<div class="item m0"><div class="hero-img" style="background-image: url({{ asset("images/media/img_58.jpg") }} );"></div></div>
			</div>
			<!-- /.hero-slider-one -->
			<div class="container position-relative z-2">
				<div class="row">
					<div class="col-lg-6 wow fadeInLeft">
						<div class="mt-45">
							<h1 class="hero-heading text-white fw-500" style="font-size:119px">
								Go Mommy!
							...
							<p class="fs-24 text-white pt-40 pb-30 md-pb-20 pe-xl-5">Explore our vast varity of themes and create your own website today.</p>
							<div class="d-inline-flex flex-wrap align-items-center">
								<a href="" class="btn-two rounded-0 border-0 mt-15 me-4"><span>Explore Themes</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5 col-lg-6 ms-auto wow fadeInRight">
						<div class="search-wrapper-two position-relative ms-xl-5 ms-lg-4 ps-xxl-4 md-mt-60">
							...
							<div class="bg-wrapper position-relative z-1">
								<h4 class="mb-35 xl-mb-30">Find & Buy Themes Now!</h4>
												...
												<div class="col-12">
													<div class="input-box-one bottom-border mb-25">
														...
														<select class="nice-select fw-normal" name="type">
															...
															<option value="entertainment">Entertainment site</option>
															<option value="food&drink">Food & Drink site</option>
												...
												<div class="col-12">
													<div class="input-box-one bottom-border mb-50 lg-mb-30">
														...
														<select class="nice-select fw-normal" name="price_range">
															...
															<option value="RS. 2000 - RS. 5000">RS. 2000 - RS. 5000</option>
		...
		<div class="container container-large">
			<div class="position-relative">
				...
				<div class="section-btn text-center md-mt-60">
					<a href="" class="btn-eight"><span>Explore All</span> <i class="bi bi-arrow-up-right"></i></a>
				</div>
			</div>
		</div>
	</div> --}}
							...
							<div class="listing-card-four overflow-hidden d-flex align-items-end position-relative z-1" style="background-image: url( '{{ asset($url) }}' );">
								...
								<div class="property-info tran3s w-100">
									<div class="d-flex align-items-center justify-content-between">
										<div class="pe-3">
											<a href="{{ route("public.property", $bestProperty->id) }}" class="title fw-500 tran4s">{{ $bestProperty->title }}.</a>
										</div>
				...
				<div class="row gx-xxl-5">
					<div class="col-lg-4 col-md-6 mt-30 d-flex wow fadeInUp">
						<div class="card-style-six d-inline-flex flex-column align-items-start tran3s h-100 w-100">
							...
							<a href="" class="btn-twelve rounded-0 sm mt-auto">Buy Home</a>
						</div>
						<!-- /.card-style-six -->
					</div>
					<div class="col-lg-4 col-md-6 mt-30 d-flex wow fadeInUp" data-wow-delay="0.1s">
						<div class="card-style-six d-inline-flex flex-column align-items-start tran3s h-100 w-100">
							...
							<a href="" class="btn-twelve rounded-0 sm mt-auto">Rent Home</a>
						</div>
						<!-- /.card-style-six -->
					</div>
					<div class="col-lg-4 col-md-6 mt-30 d-flex wow fadeInUp" data-wow-delay="0.2s">
						<div class="card-style-six d-inline-flex flex-column align-items-start tran3s h-100 w-100">
							...
							<a href="" class="btn-twelve rounded-0 sm mt-auto">Sell Home</a>
						</div>
						<!-- /.card-style-six -->
					</div>
				</div>
		...
		<div class="container container-large">
			<div class="position-relative">
				...
				<div class="wrapper flex-wrap d-flex justify-content-center justify-content-md-between align-items-center">
					<div class="card-style-seven position-relative z-1 rounded-circle overflow-hidden d-flex align-items-center justify-content-center wow fadeInUp" style="background-image: url({{ asset('images/media/img_61.jpg') }});">
						<a href="" class="title stretched-link"><h4 class="text-white tran3s">Portfolio</h4></a>
					</div>
					<!-- /.card-style-seven -->
					<div class="card-style-seven position-relative z-1 rounded-circle overflow-hidden d-flex align-items-center justify-content-center wow fadeInUp" style="background-image: url({{ asset('images/media/img_62.jpg') }});" data-wow-delay="0.1s">
						<a href="" class="title stretched-link"><h4 class="text-white tran3s">Education</h4></a>
					</div>
					<!-- /.card-style-seven -->
					<div class="card-style-seven position-relative z-1 rounded-circle overflow-hidden d-flex align-items-center justify-content-center wow fadeInUp" style="background-image: url({{ asset('images/media/img_63.jpg') }});" data-wow-delay="0.2s">
						<a href="" class="title stretched-link"><h4 class="text-white tran3s">Food & Drink</h4></a>
					</div>
					<!-- /.card-style-seven -->
					<div class="card-style-seven position-relative z-1 rounded-circle overflow-hidden d-flex align-items-center justify-content-center wow fadeInUp" style="background-image: url({{ asset('images/media/img_64.jpg') }});" data-wow-delay="0.3s">
						<a href="" class="title stretched-link"><h4 class="text-white tran3s">News</h4></a>
					</div>
					<!-- /.card-style-seven -->
				</div>
			</div>
					...
					<div class="col-xl-6 col-lg-7 col-md-7">
						<div class="pb-80 lg-pb-40">
							...
							<div class="d-inline-flex flex-wrap align-items-center position-relative mt-15">
								<a href="" class="btn-eight mt-10 me-4"><span>Become an Agent</span></a>
								<a href="" class="btn-two rounded-0 border-0 mt-10"><span>Contact us</span></a>
