<aside class="dash-aside-navbar">
    <div class="position-relative">
        ...
        <nav class="dasboard-main-nav pt-30 pb-30 bottom-line">
            <ul class="style-none">
                <li class="plr"><a href="{{ route("user.dashboard") }}" class="d-flex w-100 align-items-center ">
                ...
                <li class="plr"><a href="{{ route("user.website.websites") }}" class="d-flex w-100 align-items-center">
                ...
                <li class="plr"><a href="{{ route("landlords.contracts") }}" class="d-flex w-100 align-items-center">
                    <img src=" {{ asset("dashboard/images/icon/icon_6.svg") }} " alt="">
        ...
        <div class="profile-complete-status  pb-35 plr">
            <a  class="d-flex w-100 align-items-center logout-btn">
