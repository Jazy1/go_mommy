    ...
    <div class="d-flex align-items-center justify-content-end">
        ...
        <div class="user-data position-relative">
            <button class="user-avatar online position-relative rounded-circle dropdown-toggle" type="button" id="profile-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                ...
                " alt="" class="lazy-img"> --}}
                <img src=" {{ asset("/images/lazy.svg") }} " data-src=" {{ asset("profile-pictures/default.svg") }} " alt="" class="lazy-img">
            </button>
            <!-- /.user-avatar -->
            <div class="user-name-data">
                <ul class="dropdown-menu" aria-labelledby="profile-dropdown">
                    <li>
                        ...
                        {{-- href="/user/profile" --}}
                        ><img src="../images/lazy.svg" data-src=" {{ asset("dashboard/images/icon/icon_23.svg") }} " alt="" class="lazy-img"><span class="ms-2 ps-1">Profile</span></a>
                    </li>
                </ul>
            </div>
        </div>
