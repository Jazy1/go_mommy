			...
			<div class="container container-large">
					...
					<div class="row">
						<div class="col-xl-3 mb-40 lg-mb-60">
							<div class="footer-intro pe-xxl-5 pe-xl-3">
								...
								<!-- logo -->
								<p class="mb-45 lg-mb-30">Comsats University, Wah, PK</p>
								<p class="mb-45 lg-mb-30">Sir Faisal Shafique Butt</p>
				...
				<div class="bottom-footer">
					<div class="d-md-flex justify-content-center justify-content-md-between align-items-center">
						...
						<p class="mb-15 text-center text-lg-start fs-16 order-md-first">Copyright @2024 GoMommy inc.</p>
					</div>
				</div>
			</div>
		</div> <!-- /.footer-three -->